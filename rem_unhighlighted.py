...
factored=factored.replace("/","")
factored=factored.replace(" ","")
factored=factored.replace("|VBD|","|vb|")
factored=factored.replace("|VBZ|","|vb|")
factored=factored.replace("|VHZ|","|vb|")
factored=factored.replace("|VHD|","|vb|")
outputfile=open('C:/wamp/www/enes_dict/lemma_syntax.txt', 'w')
